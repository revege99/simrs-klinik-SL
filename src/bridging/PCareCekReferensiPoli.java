...
public final class PCareCekReferensiPoli extends javax.swing.JDialog {
    ...
    public PCareCekReferensiPoli(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628,674);
        tabMode=new DefaultTableModel(null,new String[]{"No.","Kode Unit/Poli","Nama Unit/Poli","Poli Sakit"}){
    ...
    */
    ...
    public void tampil(String diagnosa) {
	    ...
	    requestEntity = new HttpEntity(headers);
            System.out.println("===== HEADER REQUEST BPJS =====");
                    ...
                    for(JsonNode list:response.path("list")){
                        if(list.path("kdPoli").asText().toLowerCase().contains(diagnosa.toLowerCase())||
                            ...
                            tabMode.addRow(new Object[]{
                                i+".",list.path("kdPoli").asText(),list.path("nmPoli").asText(),list.path("poliSakit").asBoolean()
                            });
                            i++;
                        }
                    }
