...
public final class PCareDataPendaftaran extends javax.swing.JDialog {
    ...
    private JMenuItem MnAddMCU;
    private JMenuItem MnDetailMCU;
    private JMenuItem MnputRujukan;
    ...
    public PCareDataPendaftaran(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        //tambahan kode  add mcu
        MnAddMCU = new javax.swing.JMenuItem("Add MCU");
        MnAddMCU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png")));
        MnAddMCU.setMnemonic(KeyEvent.VK_M); // shortcut M
        MnAddMCU.setActionCommand("AddMCU");

        
            MnAddMCU.addActionListener((ActionEvent e) -> {
            int selectedRow = tbKunjungan.getSelectedRow();
            String noKunjungan = tbKunjungan.getValueAt(selectedRow, 1).toString();
            String noKartu = tbKunjungan.getValueAt(selectedRow, 5).toString();// Kolom ke-1 = noKunjungan
            if (selectedRow != -1) {

                try {
                      String url = "http://" + koneksiDB.HOSTCALL() + "/webkhanza/?page=post_mcu&noKunj=" + noKunjungan  + "&noKartu=" + noKartu;
        ...
        jPopupMenu1.add(MnAddMCU);
        //tutup kode  add mcu
        
        
         //tambahan kode  detauk mcu
        MnDetailMCU = new javax.swing.JMenuItem("Detail MCU");
        MnDetailMCU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png")));
        MnDetailMCU.setMnemonic(KeyEvent.VK_M); // shortcut M
        MnDetailMCU.setActionCommand("DetailMCu");

        
            MnDetailMCU.addActionListener((ActionEvent e) -> {
            int selectedRow = tbKunjungan.getSelectedRow();
            String noKunjungan = tbKunjungan.getValueAt(selectedRow, 1).toString(); // Kolom ke-1 = noKunjungan
            if (selectedRow != -1) {

                try {
//                    String url = "http://192.168.1.32/webkhanza/?page=data_mcu&noKunjungan=" + noKunjungan;
                    String url = "http://" + koneksiDB.HOSTCALL() + "/webkhanza/?page=data_mcu&noKunjungan=" + noKunjungan;
        ...
        jPopupMenu1.add(MnDetailMCU);
        // Tambahan kode detail MCU
//        MnDetailMCU = new javax.swing.JMenuItem();
//        MnDetailMCU.setText("Detail MCU");
//        MnDetailMCU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png")));
//        MnDetailMCU.setMnemonic(KeyEvent.VK_M); // shortcut M
//        MnDetailMCU.setActionCommand("DetailMCU");
//
...
//        String noKunjungan = tbKunjungan.getValueAt(selectedRow, 1).toString();
//        try {
//            bridging.PcareDetailMcu mcu = new bridging.PcareDetailMcu();
//            Object[][] data = mcu.getDataMCU(noKunjungan);
//            String[] columns = {"Nama Pemeriksaan", "Hasil", "Satuan", "Nilai Normal"};
//
//            JTable table = new JTable(data, columns);
//            JScrollPane scrollPane = new JScrollPane(table);
//            table.setFillsViewportHeight(true);
//
//            // Buat dialog untuk menampilkan tabel
//            JDialog dialog = new JDialog();
//            dialog.setTitle("Detail MCU - No Kunjungan: " + noKunjungan);
...
//
//        } catch (Exception ex) {
//            JOptionPane.showMessageDialog(null, "Gagal memanggil PcareDataMcu: " + ex.getMessage());
//        }
//    } else {
//        JOptionPane.showMessageDialog(null, "Silakan pilih baris data terlebih dahulu.");
//    }
...
//        jPopupMenu1.add(MnDetailMCU);
        ...
        // tutup kode detail mcu
        
        // kode untuk ubah rujukan
...
//        ppRujukanPCare.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        MnputRujukan = new javax.swing.JMenuItem("Ubah Rujukan Pcare");
        MnputRujukan.setBackground(new java.awt.Color(255, 255, 254));
        MnputRujukan.setFont(new java.awt.Font("Tahoma", 0, 11));
        MnputRujukan.setForeground(new java.awt.Color(50, 50, 50));
        MnputRujukan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png")));
        MnputRujukan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnputRujukan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnputRujukan.setMnemonic(KeyEvent.VK_M); // shortcut M
        MnputRujukan.setActionCommand("Ubah Rujukan Pcare");

        
            MnputRujukan.addActionListener((ActionEvent e) -> {
            int selectedRow = tbSpesialis.getSelectedRow();
            String noKunjungan = tbSpesialis.getValueAt(selectedRow, 1).toString(); // Kolom ke-1 = noKunjungan
            if (selectedRow != -1) {

                try {
//                    String url = "http://192.168.1.32/webkhanza/?page=put_rujukan&noKunj=" + noKunjungan;
                    String url = "http://" + koneksiDB.HOSTCALL() + "/webkhanza/?page=put_rujukan&noKunj=" + noKunjungan;
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "L.P.","Suhu","Heart Rate","Rujuk Balik","Perawatan","No.Urut","Status"
            }){
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{
                ...
                "Kode Prognosa","Nama Prognosa","Terapi Non Obat","BMHP","Suhu","Anamnesa"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        tabMode3=new DefaultTableModel(null,new Object[]{
                ...
                "Nama Alergi Makanan","Kode Alergi Udara","Nama Alergi Udara","Kode Alergi Obat","Nama Alergi Obat",
                "Kode Prognosa","Nama Prognosa","Terapi Non Obat","BMHP","Suhu","Anamnesa","Jadwal Faskes"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        //modif
           tabMode4 = new DefaultTableModel(null, new Object[]{
            ...
            "Terapi",          // terapi
            "Kd.Pulang",       // kdStatusPulang
            "Stts.Pulang",     // nmStatusPulang
            "Tgl.Pulang",      // tglPulang
            "Kd.Dokter",       // kdDokter
            "Nm.Dokter",       // nmDokter
            "ICDX 1",          // kdDiag1
            "Nm.Diagnosa 1",   // nmDiag1
            "ICDX 2",          // kdDiag2
            "Nm.Diagnosa 2",   // nmDiag2
            "ICDX 3",          // kdDiag3
            "Nm.Diagnosa 3",   // nmDiag3
            "Tgl.Est Rujuk",   // tglEstRujuk
            "Kd.PPK",          // kdPPK
            "Kd.Khusus",       // kdKhusus
            "Nm.Khusus",       // nmKhusus
            "Kd.SubSp",        // kdSubSpesialis
            "Nm.SubSp",        // nmSubSpesialis
            "Catatan",         // catatan
            "Kd.TACC",         // kdTACC
            "Nm.TACC",         // nmTACC
            "Alasan TACC",     // alasanTACC
            "Anamnesa",        // anamnesa
            "kd. Alergi Makanan", //kd alergi makanan
            "Alergi Makan",    // alergiMakan
            "kd. Alergi Udara", //kd alergi udara
            "Alergi Udara",    // alergiUdara
            "kd. Alergi Obat", //kdalergi obat
            "Alergi Obat",     // alergiObat
            "Kd.Prognosa",     // kdPrognosa
            "Nama Prognosa", //nama prognosa
            "Terapi Obat",     // terapiObat
            "Terapi Non Obat", // terapiNonObat
            "BMHP",            // bmhp
            "Suhu" ,            // suhu
            "Nama PPK Rujukan"
        }) {
        ...
        tbKhusus.setModel(tabMode4);
        tbKhusus.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbKhusus.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        
        for (i = 0; i < 39; i++) {
        TableColumn column = tbKunjungan.getColumnModel().getColumn(i);

        switch (i) {
            case 0: column.setPreferredWidth(105); break; // no_rawat
            case 1: column.setPreferredWidth(120); break; // noKunjungan
            case 2: column.setPreferredWidth(70); break;
            case 3: column.setPreferredWidth(70); break;
            case 4: column.setPreferredWidth(170); break;
            case 5: column.setPreferredWidth(100); break;
            case 6: column.setMinWidth(0); column.setMaxWidth(0); break; // kdPoli
            case 7: column.setPreferredWidth(140); break;
            case 8: column.setPreferredWidth(180); break;
            case 9: column.setMinWidth(0); column.setMaxWidth(0); break; // kdSadar
            case 10: column.setPreferredWidth(100); break;
            case 11: case 12: case 13: case 14:
                column.setPreferredWidth(40); break;
            case 15: column.setPreferredWidth(80); break;
            case 16: column.setPreferredWidth(70); break;
            case 17: column.setPreferredWidth(160); break;
            case 18: column.setMinWidth(0); column.setMaxWidth(0); break; // kdStatus
            case 19: column.setPreferredWidth(100); break;
            case 20: column.setPreferredWidth(80); break;
            case 21: column.setMinWidth(0); column.setMaxWidth(0); break; // kdDokter
            case 22: column.setPreferredWidth(140); break;
            case 23: column.setPreferredWidth(60); break;
            case 24: column.setPreferredWidth(160); break;
            case 25: column.setPreferredWidth(60); break;
            case 26: column.setPreferredWidth(160); break;
            case 27: column.setPreferredWidth(60); break;
            case 28: column.setPreferredWidth(160); break;
            case 29: column.setPreferredWidth(90); break;
            case 30: column.setPreferredWidth(90); break;
            case 31: column.setPreferredWidth(80); break;
            case 32: column.setPreferredWidth(140); break;
            case 33: column.setPreferredWidth(80); break;
            case 34: column.setPreferredWidth(140); break;
            case 35: column.setPreferredWidth(150); break;
            case 36: column.setPreferredWidth(80); break;
            case 37: column.setPreferredWidth(140); break;
            case 38: column.setPreferredWidth(200); break;
            case 39: column.setPreferredWidth(200); break;
            case 40: column.setPreferredWidth(200); break;
            case 41: column.setPreferredWidth(200); break;
            case 42: column.setPreferredWidth(200); break;
            case 43: column.setPreferredWidth(200); break;
            case 44: column.setPreferredWidth(200); break;
            case 45: column.setPreferredWidth(200); break;
            case 46: column.setPreferredWidth(200); break;
            case 47: column.setPreferredWidth(200); break;
            case 48: column.setPreferredWidth(200); break;
            case 49: column.setPreferredWidth(200); break;
            case 50: column.setPreferredWidth(200); break;
            case 51: column.setPreferredWidth(200); break;
            case 52: column.setPreferredWidth(200); break;
            case 53: column.setPreferredWidth(200); break;
        }
    }
    ...
    private void initComponents() {
        ...
        ppRujukanKhususPCare = new javax.swing.JMenuItem();
        ...
        LabelPoli18 = new widget.Label();
        KdPPKRujukanKhusus = new widget.TextBox();
        ...
        tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026 09:48:51" }));
        ...
        ppRujukanKhususPCare.setBackground(new java.awt.Color(255, 255, 254));
        ppRujukanKhususPCare.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppRujukanKhususPCare.setForeground(new java.awt.Color(50, 50, 50));
        ppRujukanKhususPCare.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppRujukanKhususPCare.setText("Cetak Rujukan Khusus PCare");
        ppRujukanKhususPCare.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppRujukanKhususPCare.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppRujukanKhususPCare.setName("ppRujukanKhususPCare"); // NOI18N
        ppRujukanKhususPCare.setPreferredSize(new java.awt.Dimension(210, 26));
        ppRujukanKhususPCare.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppRujukanKhususPCareBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu4.add(ppRujukanKhususPCare);
        ...
        TanggalDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        jLabel14.setBounds(740, 270, 60, 23);
        ...
        Keluhan.setBounds(420, 130, 310, 23);
        ...
        Status.setBounds(340, 70, 150, 23);
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        KdPoliInternal.setBounds(870, 600, 50, 23);
        ...
        NmPoliInternal.setBounds(920, 600, 170, 23);
        ...
        BtnPoliInternal.setBounds(1090, 600, 28, 23);
        ...
        TanggalEstRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        ChkInternal.setBounds(740, 600, 120, 23);
        ...
        BtnSubKhusus.setBounds(700, 530, 28, 23);
        ...
        NmSubKhusus.setBounds(530, 530, 170, 23);
        ...
        anamnesa.setBounds(810, 270, 180, 23);

        jLabel47.setText("Keluhan :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(354, 132, 60, 23);
        ...
        KdPPKRujukanKhusus.setHighlighter(null);
        KdPPKRujukanKhusus.setName("KdPPKRujukanKhusus"); // NOI18N
        KdPPKRujukanKhusus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KdPPKRujukanKhususKdPoliTujuanActionPerformed(evt);
            }
        });
        ...
        NmPPKRujukanKhusus.setHighlighter(null);
        NmPPKRujukanKhusus.setName("NmPPKRujukanKhusus"); // NOI18N
        NmPPKRujukanKhusus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NmPPKRujukanKhususKdPoliTujuanActionPerformed(evt);
            }
        });
        ...
        BtnPPKRujukanKhusus.setToolTipText("Alt+X");
        BtnPPKRujukanKhusus.setEnabled(false);
        BtnPPKRujukanKhusus.setName("BtnPPKRujukanKhusus"); // NOI18N
        BtnPPKRujukanKhusus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPPKRujukanKhususActionPerformed(evt);
            }
        });
        ...
        noKunjungan.setHighlighter(null);
        ...
        jadwalFaskes.setBounds(130, 580, 580, 23);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        DTPCari5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        DTPCari6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        tbKhusus.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbKhusus.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbKhusus.setComponentPopupMenu(jPopupMenu4);
        tbKhusus.setName("tbKhusus"); // NOI18N
        tbKhusus.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbKhususMouseClicked(evt);
            }
        });
        tbKhusus.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbKhususKeyPressed(evt);
            }
        });
        Scroll5.setViewportView(tbKhusus);
        ...
        jLabel50.setText("Tgl.Kunjungan :");
        jLabel50.setName("jLabel50"); // NOI18N
        jLabel50.setPreferredSize(new java.awt.Dimension(85, 23));
        panelGlass12.add(jLabel50);

        DTPCari7.setForeground(new java.awt.Color(50, 70, 50));
        DTPCari7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        panelGlass12.add(DTPCari7);

        jLabel51.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel51.setText("s.d.");
        jLabel51.setName("jLabel51"); // NOI18N
        jLabel51.setPreferredSize(new java.awt.Dimension(23, 23));
        panelGlass12.add(jLabel51);

        DTPCari8.setForeground(new java.awt.Color(50, 70, 50));
        DTPCari8.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2026" }));
        ...
        jLabel53.setText("Record :");
        jLabel53.setName("jLabel53"); // NOI18N
        jLabel53.setPreferredSize(new java.awt.Dimension(65, 23));
        panelGlass12.add(jLabel53);

        LCountKhusus.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        LCountKhusus.setText("0");
        LCountKhusus.setName("LCountKhusus"); // NOI18N
        LCountKhusus.setPreferredSize(new java.awt.Dimension(50, 23));
        panelGlass12.add(LCountKhusus);

        internalFrame8.add(panelGlass12, java.awt.BorderLayout.PAGE_END);

        TabRawat.addTab("Data Rujukan Khusus", internalFrame8);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(chkKunjungan.isSelected() && TerapiObat.getText().trim().isEmpty()){
            Valid.textKosong(TerapiObat, "Terapi Obat");

        }else if(chkKunjungan.isSelected() && TerapiNonObat.getText().trim().isEmpty()){
            Valid.textKosong(TerapiNonObat, "Terapi Non Obat");

        }else if(chkKunjungan.isSelected() && BMHP.getText().trim().isEmpty()){
            Valid.textKosong(BMHP, "BMHP");
        }else{
...
//kode modif
                if(ADDANTRIANAPIMOBILEJKNFKTP.equals("yes") && !Perawatan.equals("20")){
                    if(SimpanAntrianOnSite() == true){
                        insertPCare();
                    } else {
                        JOptionPane.showMessageDialog(null, "Maaf, antrian mobile JKN gagal dibuat. Silahkan cek jadwal dokter..!!");
...
//                }
//            }else{
//                JOptionPane.showMessageDialog(null,"Silahkan pilih dulu data yang mau dihapus yayaya..!!");
//            } 
...
//        }
            ...
            if (TabRawat.getSelectedIndex() == 1) {
                ...
                if (tbSpesialis.getSelectedRow() != -1) {
                    ...
                    if (konfirmasi == JOptionPane.YES_OPTION) {
                        try {
                            bodyWithPutHapusRujukanSubSpesialis();
                        } catch (Exception ex) {
                            System.out.println("Notifikasi Bridging : " + ex);
                        }
                    }
                }
            }else if (TabRawat.getSelectedIndex() == 4) { // TAB 4 = RUJUKAN KHUSUS
                if (tbKhusus.getSelectedRow() != -1) {

                    int konfirmasi = JOptionPane.showConfirmDialog(
                        null,
                        "Apakah Anda yakin ingin menghapus rujukan khusus ini?\n"
                        + "Status kunjungan akan dikembalikan ke Rawat Jalan.",
                        "Konfirmasi",
                        JOptionPane.YES_NO_OPTION
                    );
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(pilihanedit==1){
            if(tbPendaftaran.getSelectedRow()!= -1){
                if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
                    ...
                    try {
                        ...
                        if(ex.toString().contains("UnknownHostException")){
                            ...
                            JOptionPane.showMessageDialog(null,"Tidak sesuai kondisi. Aku, kamu end...! 1");
                ...
                JOptionPane.showMessageDialog(null,"Silahkan pilih dulu data yang mau dihapus..!!1");
            }    
            ...
            if(tbKunjungan.getSelectedRow()!= -1){
                if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
                    ...
                    String kdTkp = ((String) Perawatan.getSelectedItem()).substring(0, 2);

                    // Tentukan kdStatusPulang
                    String statusPulang;
                    if ("10".equals(kdTkp)) {
                        statusPulang = "3";  // fix 3 kalau kdTkp = 10
                    } else if ("20".equals(kdTkp)) {
                        statusPulang = KdStatusPulang.getText().toString();  // ikut pilihan user
                    } else {
                        statusPulang = "3";  // default
                    };
...
//                            "\"kdStatusPulang\": \"3\"," +
                            ...
                            "\"kdTacc\": -1," +
                            "\"alasanTacc\": null," +
                            "\"anamnesa\": \"" + (anamnesa.getText().equals("") ? "Tidak Ada" : anamnesa.getText()) + "\"," +
                        ...
                        String code = metaDataNode.path("code").asText();
                        String message = metaDataNode.path("message").asText();
                        String responseMsg = responseNode.isMissingNode() ? "" : responseNode.asText();

                        System.out.println("Edit Kunjungan");
                        ...
                        if (code.equals("200")) {
                            Sequel.mengedit(
                                ...
                                "tglPulang=?,kdDokter=?,nmDokter=?,kdDiag1=?,nmDiag1=?,kdDiag2=?,nmDiag2=?,kdDiag3=?,nmDiag3=?,lingkarPerut=?,KdAlergiMakanan=?,NmAlergiMakanan=?,KdAlergiUdara=?,NmAlergiUdara=?,KdAlergiObat=?,NmAlergiObat=?,KdPrognosa=?,NmPrognosa=?,terapi_non_obat=?,bmhp=?,anamnesa=?,suhu=?",
                                43,
                                new String[]{
                                    TNoRw.getText(), tbKunjungan.getValueAt(tbKunjungan.getSelectedRow(),1).toString(), Valid.SetTgl(TanggalDaftar.getSelectedItem() + ""), TNoRM.getText(), TPasien.getText(),
                                    NoKartu.getText(), KdPoliTujuan.getText(), NmPoliTujuan.getText(), Valid.MaxTeks(Keluhan.getText(), 400),
                                    KdSadar.getText(), NmSadar.getText(), Sistole.getText(), Diastole.getText(), BeratBadan.getText(),
                                    TinggiBadan.getText(), Respiratory.getText(), Heartrate.getText(), Valid.MaxTeks(TerapiObat.getText(), 2000),
                                    "3", "Berobat Jalan", Valid.SetTgl(TanggalPulang.getSelectedItem() + ""), KdTenagaMedis.getText(),
                                    Valid.MaxTeks(NmTenagaMedis.getText(), 50), KdDiagnosa1.getText(), Valid.MaxTeks(NmDiagnosa1.getText(), 400),
                                    KdDiagnosa2.getText(), Valid.MaxTeks(NmDiagnosa2.getText(), 400), KdDiagnosa3.getText(),
                                    Valid.MaxTeks(NmDiagnosa3.getText(), 400), LingkarPerut.getText(), KdAlergiMakanan.getText(),
                                    NmAlergiMakanan.getText(), KdAlergiUdara.getText(), NmAlergiUdara.getText(), KdAlergiObat.getText(),
                                    NmAlergiObat.getText(), KdPrognosa.getText(), NmPrognosa.getText(),
                                    Valid.MaxTeks(TerapiNonObat.getText(), 2000), Valid.MaxTeks(BMHP.getText(), 2000),Valid.MaxTeks(anamnesa.getText(), 2000),TSuhu.getText(),
                        ...
                        if(ex.toString().contains("UnknownHostException")){
                            ...
                            JOptionPane.showMessageDialog(null,"Tidak sesuai kondisi. Aku, kamu end...!2");
                        }else if(ex.toString().contains("204")){
                            JOptionPane.showMessageDialog(null,"Data tidak ditemukan...!");
                        }
                    }
                ...
                JOptionPane.showMessageDialog(null,"Silahkan pilih dulu data yang mau dihapus..!!2");
            }    
        }else if(pilihanedit==3){
            System.out.println("Sudah pas untuk edit rujukan.. Salam !!");
            if(tbSpesialis.getSelectedRow()!= -1){
                if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
                    Valid.textKosong(TNoRw,"Pasien");
                }else if(NoKartu.getText().trim().equals("")){
                    ...
                    try {
                        ...
                        System.out.println("code : "+nameNode.path("code").asText());
                        System.out.println("message : "+nameNode.path("message").asText());
                        System.out.println(KdStatusPulang.getText());
                        String kdStatus = KdStatusPulang.getText();
                        if(nameNode.path("code").asText().equals("200")){
                            if(kdStatus.equals("3")){
                                System.out.println("no_rawat = "+TNoRw.getText());
                                System.out.println("noKunjungan = "+noKunjungan.getText());
                            ...
                            // 2️⃣ Insert ke pcare_kunjungan_umum
                            Sequel.menyimpan(
                                "pcare_kunjungan_umum",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                43,
                                new String[]{
                                    ...
                                    noKunjungan.getText(), // noKunjungan (isi jika ada)
                                    ...
                                    KdStatusPulang.getText(),
                                    NmStatusPulang.getText(),
                                    ...
                                    NmAlergiMakanan.getText(), // NmAlergiMakanan (isi jika ada)
                                    ...
                                    Valid.MaxTeks(anamnesa.getText(),300)
                                }
                            );
                            ...
                            Sequel.mengedit("pcare_rujuk_subspesialis",
                                "no_rawat=?","no_rawat=?,tglDaftar=?,no_rkm_medis=?,nm_pasien=?,noKartu=?,kdPoli=?,nmPoli=?,keluhan=?,kdSadar=?,nmSadar=?,"+
                                ...
                                "NmAlergiObat=?,KdPrognosa=?,NmPrognosa=?,terapi_non_obat=?,bmhp=?",50,new String[]{
                                TNoRw.getText(),Valid.SetTgl(TanggalKunjungan.getSelectedItem()+""),TNoRM.getText(),TPasien.getText(), 
                            ...
                            emptTeks();  
                            JOptionPane.showMessageDialog(null,"Rujukan Berhasil diubah. Semangat Kamu !!");
                        }else{
                            JOptionPane.showMessageDialog(null,nameNode.path("message").asText());
                        }
                    }catch (Exception ex) {
                        ...
                        if(ex.toString().contains("UnknownHostException")){
                            ...
                            JOptionPane.showMessageDialog(null,"Tidak sesuai kondisi. Aku, kamu end...!3");
                        }else if(ex.toString().contains("204")){
                            JOptionPane.showMessageDialog(null,"Data tidak ditemukan...!");
                        }
                    }
            ...
            System.out.println("Sudah pas untuk edit kunjungan rujukan khusus.. Salam !!");
            if(tbKhusus.getSelectedRow()!= -1){
                if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
                    Valid.textKosong(TNoRw,"Pasien");
                }else if(NoKartu.getText().trim().equals("")){
                    ...
                    try {
                        ...
                        System.out.println(KdStatusPulang.getText());
                        requestJson ="{" +
                                            "\"noKunjungan\": \""+tbKhusus.getValueAt(tbKhusus.getSelectedRow(),1).toString()+"\"," +
                                            "\"noKartu\": \""+NoKartu.getText()+"\"," +
                        ...
                        if(nameNode.path("code").asText().equals("200")){
                            ...
                            if(kdStatus.equals("3")){
                                System.out.println("no_rawat = "+TNoRw.getText());
                            System.out.println("noKunjungan = "+noKunjungan.getText());
                            // 1️⃣ Hapus dari pcare_rujuk_khusus
//                            Sequel.meghapus("pcare_rujuk_khusus", "no_rawat=?", );
                             Sequel.meghapus(
                                "pcare_rujuk_khusus",
                                "no_rawat",
                                TNoRw.getText()
                            ...
                            Sequel.mengedit(
                                "pcare_rujuk_khusus",
                                "no_rawat=?",
                                "tglDaftar=?,no_rkm_medis=?,nm_pasien=?,noKartu=?,kdPoli=?,nmPoli=?,keluhan=?,kdSadar=?,nmSadar=?,"+
                                "sistole=?,diastole=?,beratBadan=?,tinggiBadan=?,respRate=?,heartRate=?,lingkarPerut=?,"+
                                "kdStatusPulang=?,nmStatusPulang=?,tglPulang=?,"+
                                "kdDokter=?,nmDokter=?,kdDiag1=?,nmDiag1=?,kdDiag2=?,nmDiag2=?,kdDiag3=?,nmDiag3=?,"+
                                "tglEstRujuk=?,kdPPK=?,kdKhusus=?,kdSubSpesialis=?,catatan=?,"+
                                "kdTACC=?,alasanTACC=?,anamnesa=?,"+
                                "KdAlergiMakanan=?,KdAlergiUdara=?,KdAlergiObat=?,KdPrognosa=?,"+
                                "terapiObat=?,terapiNonObat=?,bmhp=?,suhu=?,NmPPKRujukanKhusus=?",
                                45,
                                new String[]{
                                    Valid.SetTgl(TanggalKunjungan.getSelectedItem()+""),  // tglDaftar
                                    TNoRM.getText(),
                                    TPasien.getText(),
                                    NoKartu.getText(),
                                    KdPoliTujuan.getText(),
                                    ...
                                    Valid.SetTgl(TanggalEstRujuk.getSelectedItem()+""), // rujuk lanjut
                                    KdPPKRujukanKhusus.getText(),
                                    KdKhusus.getText(),
                                    null,
                                    Valid.MaxTeks(CatatanKhusus.getText(),150),

                                    KdTACC.getText(),
                                    Valid.MaxTeks(AlasanTACC.getText(),400),
                                    Valid.MaxTeks(anamnesa.getText(),400),
                                    ...
                                    Valid.MaxTeks(TerapiObat.getText(),400),
                                    Valid.MaxTeks(TerapiNonObat.getText(),400),
                                    Valid.MaxTeks(BMHP.getText(),200),
                                    TSuhu.getText(),
    ...
    private void MnPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPemberianObatActionPerformed
        if(tabMode2.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong pemberian obat...!!!!");
            TCari1.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
    ...
    private void MnTIndakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTIndakanActionPerformed
        if(tabMode2.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong tindakan 1...!!!!");
            TCari1.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            tbKunjungan.requestFocus();
    ...
    private void MnPemberianObat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPemberianObat1ActionPerformed
        if(tabMode2.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong, Silahkan pilih pasien...! Semangat kamu!!!");
            TCari1.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            tbKunjungan.requestFocus();
...
//                try {
//                    String url = "http://192.168.1.32/webkhanza/?page=data_obat&noKunjungan=" + noKunjungan;
//                    java.awt.Desktop.getDesktop().browse(new java.net.URI(url));
//                } catch (Exception ex) {
//                    JOptionPane.showMessageDialog(null, "Gagal membuka browser: " + ex.getMessage());
//                }
    ...
    private void MnTIndakan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTIndakan1ActionPerformed
        if(tabMode2.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong, tindakan...!!!!");
            TCari1.requestFocus();
        }else if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            tbKunjungan.requestFocus();
            ...
            if(tbPendaftaran.getValueAt(i,20).toString().equals("Gagal")){
                try {
                    ...
                    if(ex.toString().contains("UnknownHostException")||ex.toString().contains("unreachable")){
                        ...
                        JOptionPane.showMessageDialog(null,"Tidak sesuai kondisi. Aku, kamu end...!6");
                    }else if(ex.toString().contains("204")){
                        JOptionPane.showMessageDialog(null,"Data tidak ditemukan...!");
                    }else if(ex.toString().contains("refused")){
                        JOptionPane.showMessageDialog(null,"BPJSe ngelu...!");
...
//                                         "\"jmlObat\": "+(int)Double.parseDouble(rscari.getString("jml"))+"," +
//                                        "\"jmlPermintaan\": "+(int)Double.parseDouble(rscari.getString("jml"))+"," +
                                        "\"nmObatNonDPHO\": \"-\"" +
                                     "}";
                                    System.out.println(requestJson);
                                    requestEntity = new HttpEntity(requestJson,headers);
                                    ...
                                    if(ex.toString().contains("UnknownHostException")){
                                        ...
                                        System.out.println("Tidak sesuai kondisi. Aku, kamu end...!7");
                                    }else if(ex.toString().contains("204")){
                            ...
                            if(Sequel.cariInteger("select count(kd_jenis_prw) from pcare_tindakan_ralan_diberikan where tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and jam='"+rscari.getString("jam")+"' and no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                try {
                                    ...
                                    if(ex.toString().contains("UnknownHostException")){
                                        ...
                                        System.out.println("Tidak sesuai kondisi. Aku, kamu end...!8");
                                    }else if(ex.toString().contains("204")){
                                        System.out.println("Data tidak ditemukan...!");
                                    }
                                } 
                            ...
                            if(Sequel.cariInteger("select count(kd_jenis_prw) from pcare_tindakan_ralan_diberikan where tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and jam='"+rscari.getString("jam")+"' and no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                try {
                                    ...
                                    if(ex.toString().contains("UnknownHostException")){
                                        ...
                                        System.out.println("Tidak sesuai kondisi. Aku, kamu end...!9");
                                    }else if(ex.toString().contains("204")){
                                        System.out.println("Data tidak ditemukan...!");
                                    }
                                } 
                            ...
                            if(Sequel.cariInteger("select count(kd_jenis_prw) from pcare_tindakan_ralan_diberikan where tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and jam='"+rscari.getString("jam")+"' and no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                try {
                                    ...
                                    if(ex.toString().contains("UnknownHostException")){
                                        ...
                                        System.out.println("Tidak sesuai kondisi. Aku, kamu end...!10");
                                    }else if(ex.toString().contains("204")){
                                        System.out.println("Data tidak ditemukan...!");
                                    }
                                } 
                            ...
                            if(Sequel.cariInteger("select count(pcare_tindakan_ranap_diberikan.kd_jenis_prw) from pcare_tindakan_ranap_diberikan where pcare_tindakan_ranap_diberikan.tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and pcare_tindakan_ranap_diberikan.jam='"+rscari.getString("jam")+"' and pcare_tindakan_ranap_diberikan.no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and pcare_tindakan_ranap_diberikan.kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                try {
                                    ...
                                    if(ex.toString().contains("UnknownHostException")){
                                        ...
                                        System.out.println("Tidak sesuai kondisi. Aku, kamu end...!11");
                                    }else if(ex.toString().contains("204")){
                                        System.out.println("Data tidak ditemukan...!");
                                    }
                                } 
                            ...
                            if(Sequel.cariInteger("select count(pcare_tindakan_ranap_diberikan.kd_jenis_prw) from pcare_tindakan_ranap_diberikan where pcare_tindakan_ranap_diberikan.tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and pcare_tindakan_ranap_diberikan.jam='"+rscari.getString("jam")+"' and pcare_tindakan_ranap_diberikan.no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and pcare_tindakan_ranap_diberikan.kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                try {
                                    ...
                                    if(ex.toString().contains("UnknownHostException")){
                                        ...
                                        System.out.println("Tidak sesuai kondisi. Aku, kamu end...!12");
                                    }else if(ex.toString().contains("204")){
                                        System.out.println("Data tidak ditemukan...!");
                                    }
                                } 
                            ...
                            if(Sequel.cariInteger("select count(pcare_tindakan_ranap_diberikan.kd_jenis_prw) from pcare_tindakan_ranap_diberikan where pcare_tindakan_ranap_diberikan.tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and pcare_tindakan_ranap_diberikan.jam='"+rscari.getString("jam")+"' and pcare_tindakan_ranap_diberikan.no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and pcare_tindakan_ranap_diberikan.kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                try {
                                    ...
                                    if(ex.toString().contains("UnknownHostException")){
                                        ...
                                        System.out.println("Tidak sesuai kondisi. Aku, kamu end...!13");
                                    }else if(ex.toString().contains("204")){
                                        System.out.println("Data tidak ditemukan...!");
                                    }
                                } 
...
//        }
    ...
    private void BtnCari2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari2ActionPerformed
        System.out.println("BtnCari2 ditekan");
        tampil3();
    ...
    private void tbSpesialisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbSpesialisKeyPressed
        if(tabMode3.getRowCount() != 0){
            // Jika tekan ENTER, PANAH ATAS, atau PANAH BAWAH → ambil data
            if(evt.getKeyCode() == KeyEvent.VK_ENTER ||
                evt.getKeyCode() == KeyEvent.VK_UP ||
                evt.getKeyCode() == KeyEvent.VK_DOWN){
                try {
                    emptTeks();   // Kosongkan input
                    getData3();   // Ambil data dari baris tabel
                } catch (java.lang.NullPointerException e) {
                }
            }
            // Jika tekan SPASI → mode edit dan pindah ke tab input
            else if(evt.getKeyCode() == KeyEvent.VK_SPACE){
                try {
                    pilihanedit = 3;
                    TabRawat.setSelectedIndex(0);  // Ganti ke tab input
                } catch (java.lang.NullPointerException e) {
                }
            }   
        }
    ...
    private void tbSpesialisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSpesialisMouseClicked
        if(tabMode3.getRowCount() != 0){
            try {
                emptTeks();   // Kosongkan field input terlebih dahulu
                getData3();   // Ambil data dari baris yang dipilih
            } catch (java.lang.NullPointerException e) {
            }

            if(evt.getClickCount() == 2){
                pilihanedit = 3;                    // Aktifkan mode edit
                TabRawat.setSelectedIndex(0);   // Pindah ke tab input (index 0)
            }
        }
    ...
    private void BtnPPKRujukanKhususActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPPKRujukanKhususActionPerformed
        PCareCekFaskesAlihRawat provider = new PCareCekFaskesAlihRawat(null, true); // ✅ MODAL

        // kirim No Kartu
        provider.setNoKartu(NoKartu.getText());
        ...
        // ✅ LISTENER HARUS SEBELUM setVisible
        provider.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosed(java.awt.event.WindowEvent e) {

                System.out.println("PARENT TERIMA kdPPK = " + provider.getKdPPK());

                if(!provider.getKdPPK().equals("")){
                    KdPPKRujukanKhusus.setText(provider.getKdPPK());
                    NmPPKRujukanKhusus.setText(provider.getNmPPK());
                }
            }
        });
    ...
    }//GEN-LAST:event_BtnPPKRujukanKhususActionPerformed

    private void NmPPKRujukanKhususKdPoliTujuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NmPPKRujukanKhususKdPoliTujuanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NmPPKRujukanKhususKdPoliTujuanActionPerformed

    private void KdPPKRujukanKhususKdPoliTujuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KdPPKRujukanKhususKdPoliTujuanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdPPKRujukanKhususKdPoliTujuanActionPerformed
    ...
    //        tacc.getTable().addKeyListener(new KeyListener() {
        ...
        PCareCekReferensiTACC tacc =
        new PCareCekReferensiTACC(null,false,KdDiagnosa1.getText().trim(),NmDiagnosa1.getText().trim());
        ...
        tacc.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(tacc.getTable().getSelectedRow()!= -1){
                    KdTACC.setText(tacc.getTable().getValueAt(
                        tacc.getTable().getSelectedRow(),0).toString());
                NmTACC.setText(tacc.getTable().getValueAt(
                    tacc.getTable().getSelectedRow(),1).toString());
            AlasanTACC.setText(tacc.getTable().getValueAt(
                tacc.getTable().getSelectedRow(),2).toString());
        KdKhusus.requestFocus();
        }
        }
    ...
    private void TSuhuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TSuhuKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            try {
                int bb = Integer.parseInt(TSuhu.getText());
                if (bb < 5 || bb > 70) {
                    JOptionPane.showMessageDialog(null, "TSuhu Harus diantara 25 dan 45. Semangat Kamu !!!.");
                    TSuhu.setText("0");
                    TSuhu.requestFocus();
                } else {
                    // Fokus ke field berikutnya jika perlu
                    // Misal: TinggiBadan.requestFocus();
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "TSuhu tinggi badan harus angka!");
                TSuhu.setText("0");
                TSuhu.requestFocus();
            }
        }
...
//            NmSarana.setText("");
    ...
    private void HeartrateKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_HeartrateKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            try {
                int bb = Integer.parseInt(Heartrate.getText());
                if (bb < 3 || bb > 160) {
                    JOptionPane.showMessageDialog(null, "Heartrate Harus diantara 30 dan 160. Semangat Kamu !!!.");
                    Heartrate.setText("0");
                ...
                JOptionPane.showMessageDialog(null, "Heartrate tinggi badan harus angka!");
                Heartrate.setText("0");
                Heartrate.requestFocus();
            }
        }
    ...
    private void RespiratoryKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RespiratoryKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            try {
                int bb = Integer.parseInt(Respiratory.getText());
                if (bb < 5 || bb > 70) {
                    JOptionPane.showMessageDialog(null, "Respiratory Harus diantara 5 dan 70. Semangat Kamu !!!.");
                    Respiratory.setText("0");
                    Respiratory.requestFocus();
                } else {
                    // Fokus ke field berikutnya jika perlu
                    // Misal: TinggiBadan.requestFocus();
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Respiratory tinggi badan harus angka!");
                Respiratory.setText("0");
                Respiratory.requestFocus();
            }
        }
    ...
    private void DiastoleKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiastoleKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            try {
                int bb = Integer.parseInt(Diastole.getText());
                if (bb < 30 || bb > 180) {
                    JOptionPane.showMessageDialog(null, "Diastole Harus diantara 30 dan 180. Semangat Kamu !!!.");
                    Diastole.setText("0");
                ...
                JOptionPane.showMessageDialog(null, "Input Diastole badan harus angka!");
                Diastole.setText("0");
                Diastole.requestFocus();
            }
        }
    ...
    private void SistoleKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SistoleKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            try {
                int bb = Integer.parseInt(Sistole.getText());
                if (bb < 40 || bb > 250) {
                    JOptionPane.showMessageDialog(null, "Sistole Harus diantara 40 dan 250. Semangat Kamu !!!.");
                    Sistole.setText("0");
                ...
                JOptionPane.showMessageDialog(null, "Input Sistole badan harus angka!");
                Sistole.setText("0");
                Sistole.requestFocus();
            }
        }
    ...
    private void BeratBadanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BeratBadanKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            try {
                int bb = Integer.parseInt(BeratBadan.getText());
                if (bb < 2 || bb > 300) {
                    JOptionPane.showMessageDialog(null, "Berat Badan Harus diantara 2 dan 300 kg. Semangat Kamu !!!.");
                    BeratBadan.setText("0");
                ...
                JOptionPane.showMessageDialog(null, "Input berat badan harus angka!");
                BeratBadan.setText("0");
                BeratBadan.requestFocus();
            }
        }
    ...
    private void TinggiBadanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TinggiBadanKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            try {
                int bb = Integer.parseInt(TinggiBadan.getText());
                if (bb < 30 || bb > 250) {
                    JOptionPane.showMessageDialog(null, "Tinggi Badan Harus diantara 30 dan 250 cm. Semangat Kamu !!!.");
                    TinggiBadan.setText("0");
                ...
                JOptionPane.showMessageDialog(null, "Input tinggi badan harus angka!");
                TinggiBadan.setText("0");
                TinggiBadan.requestFocus();
            }
        }
                ...
                if(NoKartu.getText().trim().equals("")){
                    ...
                    try {
                        ...
                        if(ex.toString().contains("UnknownHostException")){
                            ...
                            JOptionPane.showMessageDialog(null,"Tidak sesuai kondisi. Aku, kamu end...!5");
                        }else if(ex.toString().contains("204")){
                            JOptionPane.showMessageDialog(null,"Data tidak ditemukan...!");
                        }else if(ex.toString().contains("refused")){
                            JOptionPane.showMessageDialog(null,"BPJSe ngelu...!");
    ...
    private void tbKhususMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKhususMouseClicked
    if(tabMode4.getRowCount() != 0){
            try {
                emptTeks();   // Kosongkan field input terlebih dahulu
                getData4();   // Ambil data dari baris yang dipilih
            } catch (java.lang.NullPointerException e) {
            }

            if(evt.getClickCount() == 2){
                pilihanedit = 4;                    // Aktifkan mode edit
                TabRawat.setSelectedIndex(0);   // Pindah ke tab input (index 0)
            }
        }

// TODO add your handling code here:
    }//GEN-LAST:event_tbKhususMouseClicked

    private void tbKhususKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbKhususKeyPressed
    if(tabMode4.getRowCount() != 0){
            // Jika tekan ENTER, PANAH ATAS, atau PANAH BAWAH → ambil data
            if(evt.getKeyCode() == KeyEvent.VK_ENTER ||
                evt.getKeyCode() == KeyEvent.VK_UP ||
                ...
                try {
                    emptTeks();   // Kosongkan input
                    getData4();   // Ambil data dari baris tabel
                } catch (java.lang.NullPointerException e) {
                }
            }
            // Jika tekan SPASI → mode edit dan pindah ke tab input
...
// TODO add your handling code here:
    }//GEN-LAST:event_tbKhususKeyPressed
    ...
    private void BtnCari3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari3ActionPerformed
        System.out.println("BtnCari3 ditekan");
        tampil4();
// TODO add your handling code here:
    ...
    private void ppRujukanKhususPCareBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppRujukanKhususPCareBtnPrintActionPerformed
                                                                     
        try {
            int row = tbKhusus.getSelectedRow();
            ...
            String noRawat = tbKhusus.getValueAt(row, 0).toString();
    ...
    */
    ...
    private widget.Button BtnPPKRujukanKhusus;
    ...
    private widget.TextBox KdPPKRujukanKhusus;
    ...
    private widget.Label LCountKhusus;
    ...
    private widget.Label LabelPoli18;
    ...
    private widget.TextBox NmPPKRujukanKhusus;
    ...
    public void tampil() {        
        ...
        try {
            ps=koneksi.prepareStatement(
                ...
                "pcare_pendaftaran.respRate,pcare_pendaftaran.lingkar_perut,pcare_pendaftaran.suhu,pcare_pendaftaran.heartRate,pcare_pendaftaran.rujukBalik,"+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("lingkar_perut"),rs.getString("suhu"),rs.getString("heartRate"),rs.getString("rujukBalik"),
    ...
    public void tampil2() {        
        ...
        try {
            ps=koneksi.prepareStatement(
                ...
                "pcare_kunjungan_umum.tinggiBadan,pcare_kunjungan_umum.respRate,pcare_kunjungan_umum.heartRate,pcare_kunjungan_umum.lingkarPerut,pcare_kunjungan_umum.suhu,"+
                ...
                "pcare_kunjungan_umum.terapi_non_obat,pcare_kunjungan_umum.bmhp,pcare_kunjungan_umum.anamnesa from pcare_kunjungan_umum where "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode2.addRow(new Object[]{
                        ...
                        rs.getString("KdPrognosa"),rs.getString("NmPrognosa"),rs.getString("terapi_non_obat"),rs.getString("bmhp"),rs.getString("suhu"),rs.getString("anamnesa")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    public void tampil3() {        
        ...
        try {
            ps=koneksi.prepareStatement(
                ...
                "pcare_rujuk_subspesialis.terapi_non_obat,pcare_rujuk_subspesialis.bmhp,pcare_rujuk_subspesialis.suhu,pcare_rujuk_subspesialis.anamnesa,pcare_rujuk_subspesialis.jadwalFaskes from pcare_rujuk_subspesialis where "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode3.addRow(new Object[]{
                        ...
                        rs.getString("terapi_non_obat"),rs.getString("bmhp"),rs.getString("suhu"),rs.getString("anamnesa"),rs.getString("jadwalFaskes")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    public void tampil4() {
        ...
        try {
            ...
            "SELECT " +
                ...
                "kdPoli, nmPoli, keluhan, kdSadar, nmSadar, " +
                "sistole, diastole, beratBadan, tinggiBadan, respRate, heartRate, lingkarPerut, " +
                "terapi, kdStatusPulang, nmStatusPulang, tglPulang, " +
                "kdDokter, nmDokter, " +
                "kdDiag1, nmDiag1, kdDiag2, nmDiag2, kdDiag3, nmDiag3, " +
                "tglEstRujuk, kdPPK, kdKhusus, nmKhusus, kdSubSpesialis, nmSubSpesialis, catatan, " +
                "kdTACC, nmTACC, alasanTACC, " +
                "anamnesa,KdAlergiMakanan, NmAlergiMakanan,KdAlergiUdara, NmAlergiUdara,KdAlergiObat, NmAlergiObat, KdPrognosa, " +
                "NmPrognosa, terapiObat, terapiNonObat, bmhp, suhu , NmPPKRujukanKhusus " +
            "FROM pcare_rujuk_khusus " +
            "WHERE tglDaftar BETWEEN ? AND ? AND (" +
                "no_rawat LIKE ? OR noKunjungan LIKE ? OR no_rkm_medis LIKE ? OR " +
                "nm_pasien LIKE ? OR noKartu LIKE ? OR nmPoli LIKE ? OR nmDokter LIKE ?" +
            ")"
        );


            ps.setString(1, Valid.SetTgl(DTPCari7.getSelectedItem()+""));
            ps.setString(2, Valid.SetTgl(DTPCari8.getSelectedItem()+""));
            for(int i=3;i<=9;i++){
                ps.setString(i,"%"+TCari3.getText().trim()+"%");
            }
            ...
            while(rs.next()){
                tabMode4.addRow(new Object[]{
                    ...
                    rs.getString("noKunjungan"),
                    rs.getString("tglDaftar"),
                    rs.getString("no_rkm_medis"),
                    rs.getString("nm_pasien"),
                    rs.getString("noKartu"),
                    rs.getString("kdPoli"),
                    rs.getString("nmPoli"),
                    rs.getString("keluhan"),
                    rs.getString("kdSadar"),
                    rs.getString("nmSadar"),
                    rs.getString("sistole"),
                    rs.getString("diastole"),
                    rs.getString("beratBadan"),
                    rs.getString("tinggiBadan"),
                    rs.getString("respRate"),
                    rs.getString("heartRate"),
                    rs.getString("lingkarperut"),
                    rs.getString("terapi"),
                    rs.getString("kdStatusPulang"),
                    rs.getString("nmStatusPulang"),
                    rs.getString("tglPulang"),
                    rs.getString("kdDokter"),
                    rs.getString("nmDokter"),
                    rs.getString("kdDiag1"),
                    rs.getString("nmDiag1"),
                    rs.getString("kdDiag2"),
                    rs.getString("nmDiag2"),
                    rs.getString("kdDiag3"),
                    rs.getString("nmDiag3"),
                    rs.getString("tglEstRujuk"),
                    rs.getString("kdPPK"),
                    rs.getString("kdKhusus"),
                    rs.getString("nmKhusus"),
                    rs.getString("kdSubSpesialis"),
                    ...
                    rs.getString("KdAlergiMakanan"),
                    rs.getString("NmAlergiMakanan"),
                    rs.getString("KdAlergiUdara"),
                    rs.getString("NmAlergiUdara"),
                    rs.getString("KdAlergiObat"),
                    rs.getString("NmAlergiObat"),
                    rs.getString("KdPrognosa"),
                    rs.getString("NmPrognosa"),
                    rs.getString("terapiObat"),
                    rs.getString("terapiNonObat"),
                    rs.getString("bmhp"),
                    rs.getString("suhu"),
                    rs.getString("NmPPKRujukanKhusus")
                });
            }

            LCountKhusus.setText(""+tabMode4.getRowCount());

        } catch (Exception e) {
            System.out.println("Notif tampil4 : "+e);
        } finally {
            try {
                if(rs!=null) rs.close();
                if(ps!=null) ps.close();
        ...
        try{
            ...
            if(Perawatan.getSelectedIndex()==0){
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "pemeriksaan_ralan.instruksi,pemeriksaan_ralan.rtl from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? "+
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        anamnesa.setText(rs.getString("pemeriksaan"));
                        NmSadar.setText(rs.getString("kesadaran"));
                        TSuhu.setText(rs.getString("suhu_tubuh"));
                        TerapiObat.setText(rs.getString("rtl"));
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        anamnesa.setText(rs.getString("keluhan")+(rs.getString("pemeriksaan").equals("")?"":", "+rs.getString("pemeriksaan")));
                        NmSadar.setText(rs.getString("kesadaran"));
                        TSuhu.setText(rs.getString("suhu_tubuh"));
                        TerapiNonObat.setText(rs.getString("instruksi").equals("")?"Tidak Ada":rs.getString("instruksi"));
                        if(rs.getString("kesadaran").equals("Compos Mentis")){
    ...
    private void getData() {
        if(tbPendaftaran.getSelectedRow()!= -1){
            ...
            TSuhu.setText(tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),16).toString());
            Heartrate.setText(tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),17).toString());
            Perawatan.setSelectedItem(tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),19).toString());
    ...
    private void getData2() {
        if(tbKunjungan.getSelectedRow()!= -1){
            ...
            TSuhu.setText(tbKunjungan.getValueAt(tbKunjungan.getSelectedRow(),41).toString());
            anamnesa.setText(tbKunjungan.getValueAt(tbKunjungan.getSelectedRow(),42).toString());
            TglLahir.setText(Sequel.cariIsi("select pasien.tgl_lahir from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
        }
    }
    ...
    private void getData3() {
        if(tbSpesialis.getSelectedRow()!= -1){
            ...
            noKunjungan.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),1).toString());
            ...
            TSuhu.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),50).toString());
            anamnesa.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),51).toString());
            jadwalFaskes.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),52).toString());
    ...
    private String val(int row, int col) {
        Object v = tbKhusus.getValueAt(row, col);
...
//        System.out.println("JUMLAH KOLOM tbKhusus = " + tbKhusus.getColumnCount());
//        System.out.println("COL[50] TerapiNonObat = " + val(row, 50));
//        System.out.println("COL[50] Anamnesa = " + val(row, 40));

        TNoRw.setText(val(row, 0));
        Valid.SetTgl(TanggalDaftar, val(row, 2));
        TNoRM.setText(val(row, 3));
        TPasien.setText(val(row, 4));
        ...
        NoKartu.setText(val(row, 5));
        noKunjungan.setText(val(row, 1));
        KdPoliTujuan.setText(val(row, 6));
        NmPoliTujuan.setText(val(row, 7));
        Keluhan.setText(val(row, 8));

        KdSadar.setText(val(row, 9));
        NmSadar.setText(val(row, 10));

        Sistole.setText(val(row, 11));
        Diastole.setText(val(row, 12));
        BeratBadan.setText(val(row, 13));
        TinggiBadan.setText(val(row, 14));
        Respiratory.setText(val(row, 15));
        Heartrate.setText(val(row, 16));
        LingkarPerut.setText(val(row, 17));

        TerapiObat.setText(val(row, 49));
        TerapiNonObat.setText(val(row, 50));
        BMHP.setText(val(row, 51));
        TSuhu.setText(val(row, 52));
        NmPPKRujukanKhusus.setText(val(row, 53));
        anamnesa.setText(val(row, 40));

        KdStatusPulang.setText(val(row, 19));
        NmStatusPulang.setText(val(row, 20));

        KdTenagaMedis.setText(val(row, 22));
        NmTenagaMedis.setText(val(row, 23));

        KdDiagnosa1.setText(val(row, 24));
        NmDiagnosa1.setText(val(row, 25));
        KdDiagnosa2.setText(val(row, 26));
        NmDiagnosa2.setText(val(row, 27));
        KdDiagnosa3.setText(val(row, 28));
        NmDiagnosa3.setText(val(row, 29));

        Valid.SetTgl(TanggalEstRujuk, val(row, 30));
        Valid.SetTgl(TanggalPulang, val(row, 21));

        KdPPKRujukan.setText(val(row, 31));
        NmPPKRujukan.setText(val(row, 32));

        KdSubSpesialis.setText(val(row, 33));
        NmSubSpesialis.setText(val(row, 34));

        KdSarana.setText(val(row, 35));
        NmSarana.setText(val(row, 36));

        KdTACC.setText(val(row, 37));
        NmTACC.setText(val(row, 38));
        AlasanTACC.setText(val(row, 39));

        KdAlergiMakanan.setText(val(row, 41));
        NmAlergiMakanan.setText(val(row, 42));
        KdAlergiUdara.setText(val(row, 43));
        NmAlergiUdara.setText(val(row, 44));
        KdAlergiObat.setText(val(row, 45));
        NmAlergiObat.setText(val(row, 46));

        KdPrognosa.setText(val(row, 47));
        NmPrognosa.setText(val(row, 48));
        ...
        KdKhusus.setText(val(row, 32));
        NmKhusus.setText(val(row, 33));
        CatatanKhusus.setText(val(row, 36));
        KdPPKRujukanKhusus.setText(val(row, 31));
    }
        ...
        try {
            ...
            if(chkKunjungan.isSelected()==true){
                if(Keluhan.getText().trim().equals("")){
                    ...
                    System.out.println(requestJson); 
                    System.out.println("Content-Type: " + headers2.getContentType());
                    System.out.println("X-cons-id: " + headers2.getFirst("X-cons-id"));
                    System.out.println("X-timestamp: " + headers2.getFirst("X-timestamp"));
                    System.out.println("X-signature: " + headers2.getFirst("X-signature"));
                    System.out.println("X-authorization: " + headers2.getFirst("X-authorization"));
...
//                        System.out.println("message : "+nameNode.path("message").asText());
                        if(nameNode.path("code").asText().equals("201")){
                            ...
                            if(Sequel.menyimpantf2("pcare_kunjungan_umum","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'Terkirim',?,?,?,?,?,?,?,?,?,?,?","No.Urut",42,new String[]{
                                TNoRw.getText(),response.asText(),Valid.SetTgl(TanggalKunjungan.getSelectedItem()+""),TNoRM.getText(),TPasien.getText(),
                                NoKartu.getText(),KdPoliTujuan.getText(),NmPoliTujuan.getText(),Valid.MaxTeks(Keluhan.getText(),400),KdSadar.getText(),NmSadar.getText(),
                                Sistole.getText(),Diastole.getText(),BeratBadan.getText(),TinggiBadan.getText(),Respiratory.getText(),Heartrate.getText(),
                                LingkarPerut.getText(),TSuhu.getText(),Valid.MaxTeks(TerapiObat.getText(),2000),"3","Berobat Jalan",Valid.SetTgl(TanggalPulang.getSelectedItem()+""),
                                KdTenagaMedis.getText(),Valid.MaxTeks(NmTenagaMedis.getText(),50),KdDiagnosa1.getText(),Valid.MaxTeks(NmDiagnosa1.getText(),400),KdDiagnosa2.getText(),
...
//                                        
            ...
            // Cetak header2 (HttpHeaders)
//            System.out.println("==== HEADERS YANG DIKIRIM ====");
//            for (Map.Entry<String, List<String>> entry : headers2.entrySet()) {
//                System.out.println(entry.getKey() + ": " + entry.getValue());
//            }

//            try {
//                org.json.JSONObject jsonPretty = new org.json.JSONObject(requestJson);
//                System.out.println("==== BODY JSON (PRETTY PRINT) ====");
//                System.out.println(jsonPretty.toString(4));
//            } catch (Exception e) {
//                System.out.println("Gagal parse JSON untuk pretty print: " + e.getMessage());
//            }
        ...
        if(Sequel.cariInteger("select count(pcare_kunjungan_umum.no_rawat) from pcare_kunjungan_umum where pcare_kunjungan_umum.no_rawat=?",norawat)==0){
            ...
            try {
                ...
                if(ex.toString().contains("UnknownHostException")){
                    ...
                    System.out.println("Tidak sesuai kondisi. Aku, kamu end...!15");
                }else if(ex.toString().contains("204")){
                    System.out.println("Data tidak ditemukan...!");
                }else if(ex.toString().contains("refused")){
    ...
    public void bodyWithDeleteRequest() throws Exception {
        ...
        try {
            ...
            System.out.println("URL yang dikirim: " + koneksiDB.URLAPIPCARE() +
            "/pendaftaran/peserta/" + tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),5).toString() +
            "/tglDaftar/" + Valid.SetTgl3(tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),1).toString()) +
            "/noUrut/" + tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),20).toString() +
            "/kdPoli/" + tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),6).toString()
        );
...
//              root = mapper.readTree(restTemplate.exchange(koneksiDB.URLAPIPCARE()+"/pendaftaran/peserta/"+"/tglDaftar/"+Valid.SetTgl3(tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),1).toString())+"/noUrut/"+tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),19).toString()+"/kdPoli/"+tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),6).toString(), HttpMethod.DELETE,new HttpEntity<String>(requestJson,headers), String.class).getBody());
//            nameNode = root.path("metaData");
                root = mapper.readTree(restTemplate.exchange(
                koneksiDB.URLAPIPCARE()+"/pendaftaran/peserta/" +
                tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),5).toString() +
                "/tglDaftar/" +
                Valid.SetTgl3(tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),1).toString()) +
                "/noUrut/" +
                tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),20).toString() +
                "/kdPoli/" +
            ...
            System.out.println("RESPON API BPJS:");
...
//                JOptionPane.showMessageDialog(null,nameNode.path("message").asText());
                    ...
                    String kode = nameNode.path("code").asText();
                    String pesan = nameNode.path("message").asText();

                    if(kode.equals("200") || kode.equals("201")){
                        JOptionPane.showMessageDialog(null, "Data sudah dihapus dari PCare.");
                        Sequel.meghapus("pcare_pendaftaran","no_rawat",tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),0).toString());
                        Sequel.meghapus("reg_periksa","no_rawat",tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),0).toString());
                        tampil();
                    } else if(kode.equals("304")){
                        JOptionPane.showMessageDialog(null, "Data sudah tidak ada di server PCare (304 Not Modified).");
                        Sequel.meghapus("pcare_pendaftaran","no_rawat",tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),0).toString());
                        Sequel.meghapus("reg_periksa","no_rawat",tbPendaftaran.getValueAt(tbPendaftaran.getSelectedRow(),0).toString());
                        tampil();
                    } else {
...
//                JOptionPane.showMessageDialog(null,"Pasien sudah dilayani. Tidak dapat dihapus !!");
                    JOptionPane.showMessageDialog(
                    null,
                    "Pasien sudah dilayani. Tidak dapat dihapus !!\nSemangat Kamu"
                );
    ...
    public void bodyWithDeleteRequest2() throws Exception {
        ...
        try {
            ...
            if(e.toString().contains("UnknownHostException")){
                ...
                JOptionPane.showMessageDialog(null,"Tidak sesuai kondisi. Aku, kamu end...!17");
            }else if(e.toString().contains("204")){
                JOptionPane.showMessageDialog(null,"Data tidak ditemukan...!");
            }else if(e.toString().contains("refused")){
                JOptionPane.showMessageDialog(null,"BPJSe ngelu...!");
    ...
    public void bodyWithDeleteRequest3() throws Exception {
        ...
        try {
            ...
            if(e.toString().contains("UnknownHostException")){
                ...
                JOptionPane.showMessageDialog(null,"Tidak sesuai kondisi. Aku, kamu end...!18");
            }else if(e.toString().contains("204")){
                JOptionPane.showMessageDialog(null,"Data tidak ditemukan...!");
            }else if(e.toString().contains("refused")){
                JOptionPane.showMessageDialog(null,"BPJSe ngelu...!");
    ...
    public void bodyWithDeleteRequest4() throws Exception {
        ...
        try {
            ...
            if(e.toString().contains("UnknownHostException")){
                ...
                JOptionPane.showMessageDialog(null,"Tidak sesuai kondisi. Aku, kamu end...!19");
            }else if(e.toString().contains("204")){
                JOptionPane.showMessageDialog(null,"Data tidak ditemukan...!");
            }else if(e.toString().contains("refused")){
                JOptionPane.showMessageDialog(null,"BPJSe ngelu...!");
    ...
    public void bodyWithPutHapusRujukanKhusus() throws Exception {
    RestTemplate restTemplate = new RestTemplate();
    ...
    try {
        ...
        int row = tbKhusus.getSelectedRow();
            if(row == -1){
                JOptionPane.showMessageDialog(null,"Pilih data rujukan khusus terlebih dahulu!");
                return;
            }
            
            String tglPulangDb = tbKhusus.getValueAt(row,21).toString();
            String tglEstRujuk = tbKhusus.getValueAt(row,30).toString();

            java.text.SimpleDateFormat dbFormat = new java.text.SimpleDateFormat("yyyy-MM-dd");
            java.text.SimpleDateFormat jsonFormat = new java.text.SimpleDateFormat("dd-MM-yyyy");
            
            String tglEstRujukJson = jsonFormat.format(dbFormat.parse(tglEstRujuk));
            String tglPulangJson = jsonFormat.format(dbFormat.parse(tglPulangDb));
            
        // ================= PAYLOAD =================
        requestJson =
            "{"
            + "\"noKunjungan\":\"" + tbKhusus.getValueAt(row,1) + "\","
            + "\"noKartu\":\"" + tbKhusus.getValueAt(row,5) + "\","
            + "\"keluhan\":\"" + tbKhusus.getValueAt(row,8) + "\","
            + "\"kdSadar\":\"" + tbKhusus.getValueAt(row,9) + "\","
            + "\"sistole\":" + tbKhusus.getValueAt(row,11) + ","
            + "\"diastole\":" + tbKhusus.getValueAt(row,12) + ","
            + "\"beratBadan\":" + tbKhusus.getValueAt(row,13) + ","
            + "\"tinggiBadan\":" + tbKhusus.getValueAt(row,14) + ","
            + "\"respRate\":" + tbKhusus.getValueAt(row,15) + ","
            + "\"heartRate\":" + tbKhusus.getValueAt(row,16) + ","
            + "\"lingkarPerut\":" + tbKhusus.getValueAt(row,17) + ","
            + "\"kdStatusPulang\":\"3\","
            + "\"tglPulang\":\"" + tglPulangJson + "\","
            + "\"kdDokter\":\"" + tbKhusus.getValueAt(row,22) + "\","
            + "\"kdDiag1\":\"" + tbKhusus.getValueAt(row,24) + "\","
            + "\"kdDiag2\":null,"
            + "\"kdDiag3\":null,"
            + "\"kdPoliRujukInternal\":null,"
            + "\"rujukLanjut\":{"
                + "\"tglEstRujuk\":\"" + tglEstRujukJson + "\","
                + "\"kdppk\":\"" + tbKhusus.getValueAt(row,31) + "\","
                + "\"subSpesialis\":null,"
                + "\"khusus\":{"
                    + "\"kdKhusus\":\"HDL\","
                    + "\"kdSubSpesialis\":null,"
                    + "\"catatan\":\"" + tbKhusus.getValueAt(row,36).toString() + "\""
                + "}"
            + "},"
            + "\"kdTacc\":1,"
            + "\"alasanTacc\":\"< 3 Hari\","
            + "\"anamnesa\":\"" + tbKhusus.getValueAt(row,40) + "\","
            + "\"alergiMakan\":\"" + tbKhusus.getValueAt(row,41) + "\","
            + "\"alergiUdara\":\"" + tbKhusus.getValueAt(row,42) + "\","
            + "\"alergiObat\":\"" + tbKhusus.getValueAt(row,43) + "\","
            + "\"kdPrognosa\":\"" + tbKhusus.getValueAt(row,44) + "\","
            + "\"terapiObat\":\"" + tbKhusus.getValueAt(row,45) + "\","
            + "\"terapiNonObat\":\"" + tbKhusus.getValueAt(row,46) + "\","
            + "\"bmhp\":\"" + tbKhusus.getValueAt(row,47) + "\","
            + "\"suhu\":\"" + tbKhusus.getValueAt(row,48) + "\""
            + "}";


        System.out.println("=== PAYLOAD RUJUKAN KHUSUS HDL ===");
        System.out.println(requestJson);
        ...
        if (nameNode.path("code").asText().equals("200")) {
            ...
            "No.Rawat", 41,
            new String[]{
                tbKhusus.getValueAt(row,0).toString(),  // no_rawat
                tbKhusus.getValueAt(row,1).toString(),  // noKunjungan
                tbKhusus.getValueAt(row,2).toString(),  // tglDaftar
                tbKhusus.getValueAt(row,3).toString(),  // no_rkm_medis
                tbKhusus.getValueAt(row,4).toString(),  // nm_pasien
                tbKhusus.getValueAt(row,5).toString(),  // noKartu
                tbKhusus.getValueAt(row,6).toString(),  // kdPoli
                tbKhusus.getValueAt(row,7).toString(),  // nmPoli
                tbKhusus.getValueAt(row,8).toString(),  // keluhan
                tbKhusus.getValueAt(row,9).toString(),  // kdSadar
                tbKhusus.getValueAt(row,10).toString(), // nmSadar
                tbKhusus.getValueAt(row,11).toString(), // sistole
                tbKhusus.getValueAt(row,12).toString(), // diastole
                tbKhusus.getValueAt(row,13).toString(), // beratBadan
                tbKhusus.getValueAt(row,14).toString(), // tinggiBadan
                tbKhusus.getValueAt(row,15).toString(), // respRate
                tbKhusus.getValueAt(row,16).toString(), // heartRate
                tbKhusus.getValueAt(row,17).toString(), // lingkarPerut
                tbKhusus.getValueAt(row,18).toString(), // terapi
                "3",                                    // kdStatusPulang
                "Berobat Jalan",                          // nmStatusPulang
                tbKhusus.getValueAt(row,21).toString(), // tglPulang
                tbKhusus.getValueAt(row,22).toString(), // kdDokter
                tbKhusus.getValueAt(row,23).toString(), // nmDokter
                tbKhusus.getValueAt(row,24).toString(), // kdDiag1
                tbKhusus.getValueAt(row,25).toString(), // nmDiag1
                tbKhusus.getValueAt(row,26).toString(), // kdDiag2
                tbKhusus.getValueAt(row,27).toString(), // nmDiag2
                tbKhusus.getValueAt(row,28).toString(), // kdDiag3
                tbKhusus.getValueAt(row,29).toString(), // nmDiag3
                "Terkirim",                             // status
                tbKhusus.getValueAt(row,41).toString(), // KdAlergiMakanan
                tbKhusus.getValueAt(row,42).toString(), // NmAlergiMakanan
                tbKhusus.getValueAt(row,43).toString(), // KdAlergiUdara
                tbKhusus.getValueAt(row,44).toString(), // NmAlergiUdara
                tbKhusus.getValueAt(row,45).toString(), // KdAlergiObat
                tbKhusus.getValueAt(row,46).toString(), // NmAlergiObat
                tbKhusus.getValueAt(row,47).toString(), // KdPrognosa
                tbKhusus.getValueAt(row,48).toString(),  // NmPrognosa
                tbKhusus.getValueAt(row,50).toString(), // terapi_non_obat
                tbKhusus.getValueAt(row,51).toString()  // bmhp
            });
...
//                "pcare_rujuk_khusus",
//                "no_rawat",
//                tbKhusus.getValueAt(tbKhusus.getSelectedRow(), 0).toString()
//            );
            JOptionPane.showMessageDialog(null, "Hapus Rujukan Khusus Berhasil");
            tampil4();
        } else {
            JOptionPane.showMessageDialog(null, nameNode.path("message").asText());
        }
        ...
        System.out.println("Notif Rujukan Khusus HDL : " + e);

        if (e.toString().contains("401")) {
            JOptionPane.showMessageDialog(null, "Unauthorized (401)");
        } else if (e.toString().contains("412")) {
            JOptionPane.showMessageDialog(null, "Data tidak sesuai kondisi (412)");
        } else {
            JOptionPane.showMessageDialog(null, "Gagal mengirim rujukan khusus");
        }
    }
}
    ...
    public void bodyWithPutHapusRujukanSubSpesialis() throws Exception {
    RestTemplate restTemplate = new RestTemplate();
    ...
    try {
        ...
        int row = tbSpesialis.getSelectedRow();
            ...
            String tglPulangDb = tbSpesialis.getValueAt(row,21).toString();
            String tglEstRujuk = tbSpesialis.getValueAt(row,30).toString();
        ...
        requestJson =
            "{"
            + "\"noKunjungan\":\"" + tbSpesialis.getValueAt(row,1) + "\","
            + "\"noKartu\":\"" + tbSpesialis.getValueAt(row,5) + "\","
            + "\"keluhan\":\"" + tbSpesialis.getValueAt(row,8) + "\","
            + "\"kdSadar\":\"" + tbSpesialis.getValueAt(row,9) + "\","
            + "\"sistole\":" + tbSpesialis.getValueAt(row,11) + ","
            + "\"diastole\":" + tbSpesialis.getValueAt(row,12) + ","
            + "\"beratBadan\":" + tbSpesialis.getValueAt(row,13) + ","
            + "\"tinggiBadan\":" + tbSpesialis.getValueAt(row,14) + ","
            + "\"respRate\":" + tbSpesialis.getValueAt(row,15) + ","
            + "\"heartRate\":" + tbSpesialis.getValueAt(row,16) + ","
            + "\"lingkarPerut\":" + tbSpesialis.getValueAt(row,17) + ","
            + "\"kdStatusPulang\":\"3\","
            + "\"tglPulang\":\"" + tglPulangJson + "\","
            + "\"kdDokter\":\"" + tbSpesialis.getValueAt(row,22) + "\","
            + "\"kdDiag1\":\"" + tbSpesialis.getValueAt(row,24) + "\","
            + "\"kdDiag2\":null,"
            + "\"kdDiag3\":null,"
            + "\"kdPoliRujukInternal\":null,"
            + "\"rujukLanjut\":{"
                + "\"tglEstRujuk\":\"" + tglEstRujukJson + "\","
                + "\"kdppk\":\"" + tbSpesialis.getValueAt(row,31) + "\","
                + "\"subSpesialis\":null,"
                + "\"khusus\":{"
                    + "\"kdKhusus\":\"HDL\","
                    + "\"kdSubSpesialis\":null,"
                    + "\"catatan\":\"" + tbSpesialis.getValueAt(row,36).toString() + "\""
                + "}"
            + "},"
            + "\"kdTacc\":1,"
            + "\"alasanTacc\":\"< 3 Hari\","
            + "\"anamnesa\":\"" + tbSpesialis.getValueAt(row,40) + "\","
            + "\"alergiMakan\":\"" + tbSpesialis.getValueAt(row,41) + "\","
            + "\"alergiUdara\":\"" + tbSpesialis.getValueAt(row,42) + "\","
            + "\"alergiObat\":\"" + tbSpesialis.getValueAt(row,43) + "\","
            + "\"kdPrognosa\":\"" + tbSpesialis.getValueAt(row,44) + "\","
            + "\"terapiObat\":\"" + tbSpesialis.getValueAt(row,45) + "\","
            + "\"terapiNonObat\":\"" + tbSpesialis.getValueAt(row,46) + "\","
            + "\"bmhp\":\"" + tbSpesialis.getValueAt(row,47) + "\","
            + "\"suhu\":\"" + tbSpesialis.getValueAt(row,48) + "\""
            + "}";


        System.out.println("=== PAYLOAD RUJUKAN KHUSUS Sub SPesialis ===");
        System.out.println(requestJson);
        ...
        if (nameNode.path("code").asText().equals("200")) {
            ...
            "No.Rawat", 41,
            new String[]{
                tbSpesialis.getValueAt(row,0).toString(),  // no_rawat
                tbSpesialis.getValueAt(row,1).toString(),  // noKunjungan
                tbSpesialis.getValueAt(row,2).toString(),  // tglDaftar
                tbSpesialis.getValueAt(row,3).toString(),  // no_rkm_medis
                tbSpesialis.getValueAt(row,4).toString(),  // nm_pasien
                tbSpesialis.getValueAt(row,5).toString(),  // noKartu
                tbSpesialis.getValueAt(row,6).toString(),   // kdPoli
                tbSpesialis.getValueAt(row,7).toString(),  // nmPoli
                tbSpesialis.getValueAt(row,8).toString(),  // keluhan
                tbSpesialis.getValueAt(row,9).toString(),  // kdSadar
                tbSpesialis.getValueAt(row,10).toString(), // nmSadar
                tbSpesialis.getValueAt(row,11).toString(), // sistole
                tbSpesialis.getValueAt(row,12).toString(), // diastole
                tbSpesialis.getValueAt(row,13).toString(), // beratBadan
                tbSpesialis.getValueAt(row,14).toString(), // tinggiBadan
                tbSpesialis.getValueAt(row,15).toString(), // respRate
                tbSpesialis.getValueAt(row,16).toString(), // heartRate
                tbSpesialis.getValueAt(row,17).toString(), // lingkarPerut
                tbSpesialis.getValueAt(row,18).toString(), // terapi
                "3",                                    // kdStatusPulang
                "Berobat Jalan",                          // nmStatusPulang
                tbSpesialis.getValueAt(row,21).toString(), // tglPulang
                tbSpesialis.getValueAt(row,22).toString(), // kdDokter
                tbSpesialis.getValueAt(row,23).toString(), // nmDokter
                tbSpesialis.getValueAt(row,24).toString(), // kdDiag1
                tbSpesialis.getValueAt(row,25).toString(), // nmDiag1
                tbSpesialis.getValueAt(row,26).toString(), // kdDiag2
                tbSpesialis.getValueAt(row,27).toString(), // nmDiag2
                tbSpesialis.getValueAt(row,28).toString(), // kdDiag3
                tbSpesialis.getValueAt(row,29).toString(), // nmDiag3
                "Terkirim",                             // status
                tbSpesialis.getValueAt(row,38).toString(), // KdAlergiMakanan
                 tbSpesialis.getValueAt(row,39).toString(), // NmAlergiMakanan
                tbSpesialis.getValueAt(row,40).toString(), // KdAlergiUdara
                 tbSpesialis.getValueAt(row,41).toString(), // NmAlergiUdara
                tbSpesialis.getValueAt(row,42).toString(), // KdAlergiObat
                 tbSpesialis.getValueAt(row,43).toString(), // NmAlergiObat
                tbSpesialis.getValueAt(row,44).toString(), // KdPrognosa
                 tbSpesialis.getValueAt(row,45).toString(),  // NmPrognosa
                tbSpesialis.getValueAt(row,46).toString(), // terapi_non_obat
                tbSpesialis.getValueAt(row,47).toString()  // bmhp
            });
            ...
            JOptionPane.showMessageDialog(null, "Hapus Rujukan Sub Spesialis Berhasil");
            tampil3();
        } else {
            JOptionPane.showMessageDialog(null, nameNode.path("message").asText());
        }
        ...
        if (e.toString().contains("401")) {
            ...
            JOptionPane.showMessageDialog(null, "Gagal mengirim rujukan Sub Spesialis");
        }
    }
}
                                ...
                                if(tbPendaftaran.getValueAt(i,20).toString().equals("Gagal")){
                                    try {
                                        ...
                                        if(ex.toString().contains("UnknownHostException")||ex.toString().contains("unreachable")){
                                            ...
                                            PesanKirim.append("Tidak sesuai kondisi. Aku, kamu end...!20"+"\n");
                                        }else if(ex.toString().contains("204")){
                                                ...
                                                if(Sequel.cariInteger("select count(pcare_kunjungan_umum.no_rawat) from pcare_kunjungan_umum where pcare_kunjungan_umum.no_rawat=?",tbPendaftaran.getValueAt(i,0).toString())==0){
                                                    ...
                                                    try {
                                                        ...
                                                        if(ex.toString().contains("UnknownHostException")){
                                                            ...
                                                            PesanKirim.append("Tidak sesuai kondisi. Aku, kamu end...!21\n");
                                                        }else if(ex.toString().contains("204")){
                                                            PesanKirim.append("Data tidak ditemukan...!\n");
                                                        }else if(ex.toString().contains("refused")){
                                                            PesanKirim.append("BPJSe ngelu...!\n");
                                                ...
                                                if(Sequel.cariInteger("select count(pcare_obat_diberikan.kode_brng) from pcare_obat_diberikan where pcare_obat_diberikan.tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and pcare_obat_diberikan.jam='"+rscari.getString("jam")+"' and pcare_obat_diberikan.no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and pcare_obat_diberikan.kode_brng='"+rscari.getString("kode_brng")+"'")==0){
                                                    ...
                                                    try {
                                                        ...
                                                        if(ex.toString().contains("UnknownHostException")){
                                                            ...
                                                            PesanKirim.append("Tidak sesuai kondisi. Aku, kamu end...!22\n");
                                                        }else if(ex.toString().contains("204")){
                                                            PesanKirim.append("Data tidak ditemukan...!\n");
                                                        }
                                                    } 
                                                ...
                                                if(Sequel.cariInteger("select count(kd_jenis_prw) from pcare_tindakan_ralan_diberikan where tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and jam='"+rscari.getString("jam")+"' and no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                                    try {
                                                        ...
                                                        if(ex.toString().contains("UnknownHostException")){
                                                            ...
                                                            PesanKirim.append("Tidak sesuai kondisi. Aku, kamu end...!23\n");
                                                        }else if(ex.toString().contains("204")){
                                                            PesanKirim.append("Data tidak ditemukan...!\n");
                                                        }
                                                    } 
                                                ...
                                                if(Sequel.cariInteger("select count(kd_jenis_prw) from pcare_tindakan_ralan_diberikan where tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and jam='"+rscari.getString("jam")+"' and no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                                    try {
                                                        ...
                                                        if(ex.toString().contains("UnknownHostException")){
                                                            ...
                                                            PesanKirim.append("Tidak sesuai kondisi. Aku, kamu end...!24\n");
                                                        }else if(ex.toString().contains("204")){
                                                            PesanKirim.append("Data tidak ditemukan...!\n");
                                                        }
                                                    } 
                                                ...
                                                if(Sequel.cariInteger("select count(kd_jenis_prw) from pcare_tindakan_ralan_diberikan where tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and jam='"+rscari.getString("jam")+"' and no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                                    try {
                                                        ...
                                                        if(ex.toString().contains("UnknownHostException")){
                                                            ...
                                                            PesanKirim.append("Tidak sesuai kondisi. Aku, kamu end...!25\n");
                                                        }else if(ex.toString().contains("204")){
                                                            PesanKirim.append("Data tidak ditemukan...!\n");
                                                        }
                                                    } 
                                                ...
                                                if(Sequel.cariInteger("select count(pcare_tindakan_ranap_diberikan.kd_jenis_prw) from pcare_tindakan_ranap_diberikan where pcare_tindakan_ranap_diberikan.tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and pcare_tindakan_ranap_diberikan.jam='"+rscari.getString("jam")+"' and pcare_tindakan_ranap_diberikan.no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and pcare_tindakan_ranap_diberikan.kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                                    try {
                                                        ...
                                                        if(ex.toString().contains("UnknownHostException")){
                                                            ...
                                                            PesanKirim.append("Tidak sesuai kondisi. Aku, kamu end...!26\n");
                                                        }else if(ex.toString().contains("204")){
                                                            PesanKirim.append("Data tidak ditemukan...!\n");
                                                        }
                                                    } 
                                                ...
                                                if(Sequel.cariInteger("select count(pcare_tindakan_ranap_diberikan.kd_jenis_prw) from pcare_tindakan_ranap_diberikan where pcare_tindakan_ranap_diberikan.tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and pcare_tindakan_ranap_diberikan.jam='"+rscari.getString("jam")+"' and pcare_tindakan_ranap_diberikan.no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and pcare_tindakan_ranap_diberikan.kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                                    try {
                                                        ...
                                                        if(ex.toString().contains("UnknownHostException")){
                                                            ...
                                                            PesanKirim.append("Tidak sesuai kondisi. Aku, kamu end...!27\n");
                                                        }else if(ex.toString().contains("204")){
                                                            PesanKirim.append("Data tidak ditemukan...!\n");
                                                        }
                                                    } 
                                                ...
                                                if(Sequel.cariInteger("select count(pcare_tindakan_ranap_diberikan.kd_jenis_prw) from pcare_tindakan_ranap_diberikan where pcare_tindakan_ranap_diberikan.tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and pcare_tindakan_ranap_diberikan.jam='"+rscari.getString("jam")+"' and pcare_tindakan_ranap_diberikan.no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and pcare_tindakan_ranap_diberikan.kd_jenis_prw='"+rscari.getString("kd_jenis_prw")+"'")==0){
                                                    try {
                                                        ...
                                                        if(ex.toString().contains("UnknownHostException")){
                                                            ...
                                                            PesanKirim.append("Tidak sesuai kondisi. Aku, kamu end...!28\n");
                                                        }else if(ex.toString().contains("204")){
                                                            PesanKirim.append("Data tidak ditemukan...!\n");
                                                        }
                                                    } 
    ...
    private void insertPCare(){
        try {
            ...
            System.out.println(requestJson);
            requestEntity = new HttpEntity(requestJson,headers);
            System.out.println("URL : "+koneksiDB.URLAPIPCARE()+"/pendaftaran"+"\n");
            requestJson=api.getRest().exchange(koneksiDB.URLAPIPCARE()+"/pendaftaran", HttpMethod.POST, requestEntity, String.class).getBody();
            System.out.println(requestJson);
            root = mapper.readTree(requestJson);
            nameNode = root.path("metaData");
...
//            System.out.println("message : "+nameNode.path("message").asText());
            if(nameNode.path("code").asText().equals("201")){
                response = mapper.readTree(api.Decrypt(root.path("response").asText(),utc)).path("message");
//                System.out.println("noUrut : "+response.asText());
                if(Sequel.menyimpantf("pcare_pendaftaran","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'Terkirim'","No.Urut",21,new String[]{
                    TNoRw.getText(),Valid.SetTgl(TanggalDaftar.getSelectedItem()+""),TNoRM.getText(),TPasien.getText(),ProviderPeserta.getText(),
                    NoKartu.getText(),KdPoliTujuan.getText(),NmPoliTujuan.getText(),Keluhan.getText(),JenisKunjungan.getSelectedItem().toString(),
                    Sistole.getText(),Diastole.getText(),BeratBadan.getText(),TinggiBadan.getText(),Respiratory.getText(),LingkarPerut.getText(),TSuhu.getText(),
                    Heartrate.getText(),"0",Perawatan.getSelectedItem().toString(),response.asText()
                })==true){  
                    if(Perawatan.getSelectedIndex()==0){
                        if(!kdptg.equals("")){
...
//                "pasien.no_ktp,pasien.no_tlp,pasien.no_peserta from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where reg_periksa.no_rawat=?");
                ps = koneksi.prepareStatement(
                    "SELECT RIGHT(reg_periksa.no_reg, 3) AS no_reg, " +
                    "reg_periksa.tgl_registrasi, reg_periksa.kd_dokter, reg_periksa.kd_poli, reg_periksa.stts_daftar, reg_periksa.no_rkm_medis, reg_periksa.kd_pj, " +
                    "pasien.no_ktp, pasien.no_tlp, pasien.no_peserta " +
...
//                        System.out.println("Kode Poli : "+rs.getString("kd_poli"));
                        ...
                        if(rscari.next()){
                            ...
                            statusantrean=true;
                            System.out.println("Jadwal tidak ditemukan ya yaya...!");
                        }
                    } catch (Exception ex) {
                        statusantrean=false;
