...
public final class PCareMapingPoli extends javax.swing.JDialog {
    ...
    public PCareMapingPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "Kode Poli","Nama Poli","Kode Poli PCare","Nama Poli PCare","Poli Sakit"}){
        ...
        polipcare.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(polipcare.getTable().getSelectedRow()!= -1){                   
                    ...
                    polisakit.setText(polipcare.getTable().getValueAt(polipcare.getTable().getSelectedRow(),3).toString());
    ...
    private void initComponents() {
        ...
        NmPoliPCare.setBounds(500, 10, 190, 23);
        ...
        btnPoliBPJS.setBounds(810, 10, 28, 23);

        polisakit.setEditable(false);
        polisakit.setName("polisakit"); // NOI18N
        FormInput.add(polisakit);
        polisakit.setBounds(690, 10, 120, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(KdPoliPCare.getText().trim().equals("")||NmPoliPCare.getText().trim().equals("")||polisakit.getText().trim().equals("")){
            Valid.textKosong(KdPoliPCare,"Poli PCare");
        }else{
            if(Sequel.menyimpantf("maping_poliklinik_pcare","?,?,?,?","Mapping Poli",4,new String[]{
                kdpoli.getText(),KdPoliPCare.getText(),NmPoliPCare.getText(),polisakit.getText()
            })==true){
                tampil();
                emptTeks();
            }                
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    ...
    */
    ...
    private widget.TextBox polisakit;
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   "select maping_poliklinik_pcare.kd_poli_rs,poliklinik.nm_poli,maping_poliklinik_pcare.kd_poli_pcare,maping_poliklinik_pcare.nm_poli_pcare,maping_poliklinik_pcare.polisakit "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("kd_poli_rs"),rs.getString("nm_poli"),rs.getString("kd_poli_pcare"),rs.getString("nm_poli_pcare"),rs.getString("polisakit")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
       if(tbJnsPerawatan.getSelectedRow()!= -1){
           ...
           polisakit.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),4).toString());
        }
    }
