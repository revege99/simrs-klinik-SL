...
//            component.setBackground(new Color(6,92,45));
...
public class WarnaTableKasirRalan extends DefaultTableCellRenderer {
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
        ...
        // ===== Jenis Bayar BPJS (Tambahan Baru) =====
        String jenisBayar = String.valueOf(table.getValueAt(row,9));
        if(jenisBayar.equalsIgnoreCase("BPJS")){
            component.setBackground(new Color(15,81,128)); // Biru lembut
            component.setForeground(new Color(255,230,230));
        }
        ...
        // ===== Sudah Bayar (Override Final) =====
        String bayar = String.valueOf(table.getValueAt(row,15));
        if(bayar.equals("Sudah Bayar")){
            component.setBackground(new Color(50,50,50));
            component.setForeground(new Color(255,255,255));
        }
