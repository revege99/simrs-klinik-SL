...
import bridging.ApiMobileJKNFKTP;
...
public class DlgJadwal extends javax.swing.JDialog {
    ...
    private DefaultTableModel tabModeHfis;
    ...
    private void initComponents() {
        ...
        BtnCariHfis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept.png"))); // NOI18N
        BtnCariHfis.setMnemonic('6');
        BtnCariHfis.setToolTipText("Alt+6");
        BtnCariHfis.setName("BtnCariHfis"); // NOI18N
        BtnCariHfis.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnCariHfis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCariHfisActionPerformed(evt);
            }
        });
        BtnCariHfis.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnCariHfisKeyPressed(evt);
            }
        });
        panelGlass9.add(BtnCariHfis);

        jPanel3.add(panelGlass9, java.awt.BorderLayout.PAGE_START);

        internalFrame1.add(jPanel3, java.awt.BorderLayout.PAGE_END);

        panelBiasa1.setBackground(new java.awt.Color(0, 153, 153));
...
private void BtnPoliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPoliActionPerformed
   poli.isCek();
    ...
    private void BtnCariHfisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariHfisActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        tampilHfis();
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_BtnCariHfisActionPerformed

    private void BtnCariHfisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariHfisKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            BtnCariActionPerformed(null);
        }else{
            Valid.pindah(evt,TCari,BtnPrint);
        }
    }//GEN-LAST:event_BtnCariHfisKeyPressed
    ...
    */
    ...
    private widget.Button BtnCariHfis;
